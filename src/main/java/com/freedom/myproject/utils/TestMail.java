...
public class TestMail {
    ...
    public static void sendMail(String receiveMailName,String receiveMailAccount) {
...
// 3. 创建一封邮件
        ...
        try {
            message = createMimeMessage(session, myEmailAccount, receiveMailAccount,receiveMailName);
...
// 7. 关闭连接
    ...
    private static   MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String receiveMailName) throws Exception {
// 1. 创建一封邮件
...
// 3. To: 收件人（可以增加多个收件人、抄送、密送）
        ...
        message.setContent("<b>尊敬的"+"<span style='background-color:yellow'>"+receiveMailName+"</span>"+"恭喜您注册成功!欢迎使用本公司的产品，请注意保持邮箱的有效性，您可通过此邮箱找回密码！</b>", "text/html;charset=UTF-8");
